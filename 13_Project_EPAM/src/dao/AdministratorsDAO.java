...
public class AdministratorsDAO{
    public static void adminAdding(Administrator a1) throws IOException {
    ...
    public static List adminReading() throws IOException {
    ...
    public static void adminRewriting(List<Administrator> administrators) throws IOException {
        ObjectMapper mapper = new ObjectMapper();
